    ...
    <>
      <div
        className="invisible group-hover:visible
          flex-col z-[5]
           bg-white text-black shadow-md rounded
           absolute 
           top-[54px] h-[370px] w-[260px]
      ...
      >
            ...
            {LangArray.map((ele, index) => {
              return (
                ...
                >
                  <a
                    href="#"
                    className=" hover:text-orange-400 hover:underline flex"
                  >
                    <fieldset>
        ...
        <a
          href="#"
          className="absolute left-10 bottom-24 text-blue-600 font-semibold text-[13px] hover:underline"
        >
          Learn more
        </a>
        <div
        ...
        <a
          href="#"
          className="absolute left-10 bottom-5 text-blue-600 font-semibold text-[13px] hover:underline"
        >

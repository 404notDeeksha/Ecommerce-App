...
export const getTrending = () => {
    const IdArray = AddId(trending);
    return IdArray;
  };
  
  export const getProgramFeatures = () => {
    const IdArray = AddId(programsFeatures);
    return IdArray;
  };
  
  export const getProgramFeaturesExtra = () => {
    const IdArray = AddId(programsFeaturesExtra);
    return IdArray;
  };
  
  export const getDigitalContent = () => {
    const IdArray = AddId(digitalContent);
    return IdArray;
  };
  
  export const getShopCategory = () => {
    const IdArray = AddId(shopCategory);
    return IdArray;
  };
  
  export const getExtraShopCategory = () => {
    const IdArray = AddId(shopCategoryExtra);
    return IdArray;
  };
  
  export const getHelpSettings = () => {
    const IdArray = AddId(helpSettings);
    return IdArray;
  };

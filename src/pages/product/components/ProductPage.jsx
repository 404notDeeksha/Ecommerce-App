...
// import { ProductSkeleton } from "./ProductSkeleton";
// import { Skeleton } from "../../../components/Skeleton";
// import { getProduct, addToCart } from "../../../api/protectedApi";
// import { useSelector } from "react-redux";
// import { routes } from "../../../routes/routes";
...
//   return (
//     <div className="w-full min-w-[996px] max-w-[1500px] bg-[#fff] px-6 py-5 my-0 mx-auto">
//       <div className="flex">
//         <div className="w-[540px]">
//           <img
//             src={getImages(productData?.images?.[0])}
//             className="w-full h-auto"
...
//         <div className="mx-8 flex-1 flex flex-col gap-3">
//           <h1 className="text-4xl font-bold">{productData?.productName}</h1>
//           <p className="text-2xl font-medium">{productData?.productDescription}</p>
...
//             <select
//               id="qty"
//               className="w-28 border border-gray-400 rounded text-center py-1 px-5 bg-gray-200"
//               value={quantity}
...
//             <button
//               className="px-5 py-1 bg-yellow-500 rounded-xl text-sm"
//               onClick={handleAddToCart}
//             >
//               Add to Cart
//             </button>

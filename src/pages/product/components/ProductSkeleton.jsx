...
export const ProductSkeleton = () => {
  return (
    <div className="w-full min-w-[996px] max-w-[1500px] bg-[#fff] px-[18px] py-3.5 my-0 mt-5 mx-auto animate-pulse ">
      <div className="flex">
        <div className="bg-slate-200 font-bold h-[580px] w-[580px] "></div>

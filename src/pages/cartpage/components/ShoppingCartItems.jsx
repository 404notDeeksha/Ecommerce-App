...
// import { useDispatch, useSelector } from "react-redux";
// import { setCart } from "../../../../redux/slices/cartSlice";
// import { getCart, getTotalQtyFromCart, convertNumberInNumerals } from "../../../../utils/common-consts";
...
//   // Wrap setCartData with useCallback to avoid unnecessary re-renders
...
//   if (loading) {
//     return <Skeleton Component={ShoppingCartSkeleton} repeatations={1} />;
//   }
...
//         {cartDataInternal?.items?.map((product, index) => (
//           <ProductCard
//             key={product.productId || index} // Prefer a unique productId
//             product={product}
//             index={index}
//             userId={cartDataInternal.userId}
//             productId={product.productId}
